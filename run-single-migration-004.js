...
async function executeSql() {
  ...
  try {
    const sqlStatement = fs.readFileSync(
      path.resolve(process.cwd(), 'prisma/migrations/004_add_missing_business_info_columns.sql'),
      'utf8'
    );
    console.log(`🚀 Executing SQL from 004_add_missing_business_info_columns.sql`);
